...
onMounted(async()=>{
  ...
  //  console.log('打印carelist',cateList.value);
...
const changeCate=(e)=>{
// console.log('打印changeCate',e);
formModel.value.cate_id =e
// console.log('打印formvalue',formModel.value);
...
const open = async (row) => {
  ...
  if (row.id) {
    ...
    // console.log('打印row',cateList.value);
    
    const res = await artGetDetailService(row.id)
    formModel.value = res.data.data
    valueS.value= formModel.value.cate_name
    // 图片需要单独处理回显
